<template>
  <div class="white lighten-3" >
    <h1 class="heading">Житлові комплекси бізнес</h1>
    <v-container>
      <v-row no-gutters>

        <v-col cols="12" sm="4" md="4" lg="4" v-cloak>

          <h3 class="heading" style="color:#002244;">Бізнес 30</h3>
        ...
        <v-col cols="12" sm="4" md="4" lg="4" v-cloak>
          ...
          <h3 class="heading" style="color:#002244;">Бізнес 50</h3>
          <div class="services_price">
        ...
        <v-col cols="12" sm="4" md="4" lg="4" v-cloak>
          ...
          <h3 class="heading" style="color:#002244;">Бізнес 100</h3>
          <div class="services_price">
